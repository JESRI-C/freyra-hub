    ...
    <main className="p-6 max-w-[1400px] w-full mx-auto space-y-5">
      ...
      <Card className="overflow-hidden">
          ...
          <div className="absolute bottom-4 left-4 right-4 text-white flex items-end justify-between gap-4">
            <div>
              ...
              <div className="text-sm opacity-90 inline-flex items-center gap-1">
                <MapPin className="h-4 w-4" /> {project.location}, {project.country} ·{" "}
                {project.natureType}
              </div>
            </div>
          </div>
        ...
        <div className="p-4 flex flex-wrap items-center justify-between gap-3">
          <div className="text-sm text-muted-foreground">
            Standard: <span className="text-foreground font-medium">{project.standard}</span> ·
            Verifier: <span className="text-foreground font-medium">{project.verifier}</span>
          </div>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-3">
        <ImpactMetricCard
          ...
          value={`${project.biodiversityIndex}`}
          unit="/100"
          icon={<Sprout className="h-4 w-4" />}
        />
        <ImpactMetricCard
          label="Areal"
          value={`${project.hectares}`}
          unit="ha"
          icon={<Trees className="h-4 w-4" />}
        />
        <ImpactMetricCard
          label="CO₂e potentiale"
          value={`${project.co2ePotential.toLocaleString("da-DK")}`}
          unit="t"
          icon={<Leaf className="h-4 w-4" />}
        />
        <ImpactMetricCard
          label="Datakvalitet"
          value={`${project.dataQuality}`}
          unit="%"
      ...
      <div className="grid lg:grid-cols-3 gap-5">
        ...
        <Card className="lg:col-span-2 p-5">
          ...
          <p className="text-sm leading-relaxed text-foreground/85">
            Skallebæk Biodiversity Pilot er et tværfagligt naturgenopretningsprojekt langs Skallebæk
            i Haderslev Kommune. Projektet kombinerer hydrologisk genskabning af vandløbet,
            etablering af eng- og vådområder samt beskyttelse af eksisterende skovkant.
          </p>
          <div className="grid sm:grid-cols-2 gap-4 mt-4 text-sm">
            <div>
              <div className="font-medium mb-1">Hvorfor det betyder noget</div>
              <p className="text-muted-foreground leading-relaxed">
                Området er identificeret som kritisk korridor mellem to Natura 2000-områder.
                Genopretning øger forbindelsen mellem habitater og forbedrer både biodiversitet og
                vandkvalitet nedstrøms.
              </p>
            </div>
            <div>
            ...
            <div className="sm:col-span-2">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Alle målinger registreres i ESG Ledger med tidsstempel, kilde og metodikreference.
                Data krydsvalideres mod Sentinel-2 satellitlag og kvartalsvise feltobservationer fra
                DCE.
              </p>
            </div>
          </div>
        ...
        <Card>
          <CardHeader
            title="Risiko og usikkerhed"
            subtitle="Aktuelle observationer fra DecisionsIQ"
          />
          <ul className="px-5 pb-5 space-y-3 text-sm">
            {[
              {
                t: "Datahuller i sommermåneder",
                level: "Medium",
                note: "2 sensorer offline 12 dage i juli",
              },
              {
                t: "Sæsonvariation i artsobservationer",
                level: "Lav",
                note: "Kompenseret med multi-årig baseline",
              },
              {
                t: "Måleusikkerhed på CO₂-flux",
                level: "Medium",
                note: "±18% — anbefal flere kammermålinger",
              },
              {
                t: "Compliance: ESRS E4 dokumentation",
                level: "Lav",
                note: "Mangler kun engelsk audit-bilag",
              },
            ].map((r) => (
              <li key={r.t} className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <RiskBadge level={r.level as "Lav" | "Middel" | "Høj"} />
                  </div>
            ...
            <li className="border-t pt-3 text-xs text-muted-foreground">
              ...
              Tilføj 2 ekstra vandkvalitetssensorer i zone B og udvid feltbesøg til månedlig kadence
              i Q3.
            </li>
          </ul>
        </Card>
      ...
      <Card>
        <CardHeader
          title="Projektzoner og målepunkter"
          subtitle="Zone A · vandløb — Zone B · eng & vådområde — Zone C · skovkant"
        />
          ...
          <table className="w-full text-sm">
            <thead className="text-left text-xs text-muted-foreground border-y bg-muted/40">
              <tr>
                ...
                <th className="py-2">Sidst opdateret</th>
                <th className="py-2 w-28">Kvalitet</th>
            ...
            <tbody className="divide-y">
              {[
                ...
                {
                  i: <Satellite className="h-4 w-4" />,
                  n: "Sentinel-2 satellit",
                  s: "Aktiv",
                  d: "i går",
                  q: 88,
                  v: "Verificeret",
                ...
                {
                  i: <ClipboardCheck className="h-4 w-4" />,
                  n: "Feltregistrering (DCE)",
                  s: "Aktiv",
                  d: "1 uge siden",
                  q: 90,
                  v: "3.parts",
                ...
                },
                {
                  ...
                  n: "Tredjepartsverifikation",
                  s: "Igangværende",
                  d: "påbegyndt 2026-05-04",
                  q: 92,
                  v: "Bureau Veritas",
                },
              ].map((r) => (
                <tr key={r.n}>
                  ...
                  <td>
                    <Pill tone="success">{r.s}</Pill>
                  </td>
                  <td className="text-muted-foreground text-xs">{r.d}</td>
                  <td className="pr-3">
                    <DataQualityScore value={r.q} label="" />
                  </td>
        ...
        <CardHeader
          ...
          action={
            <div className="flex gap-2">
              ...
              <Link
                to="/app/ledger"
                className="text-sm rounded-lg bg-primary text-primary-foreground px-3 py-1.5 inline-flex items-center gap-1.5"
              >
