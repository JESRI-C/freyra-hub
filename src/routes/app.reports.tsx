...
import { LayoutDashboard, FilePlus, Wrench, Eye, ShieldCheck, LayoutTemplate, Library, Send } from "lucide-react";
...
function ReportsLayout() {
  ...
  return (
    <>
      <AppTopbar title="Rapporter" subtitle="AI-assisteret rapporteringsstudie til ESG, natur og impact" />
