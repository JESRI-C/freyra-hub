...
export const LAYER_DEFS: {
  ...
  {
    key: "field",
    label: "Feltobservationer",
    lastUpdated: "1 t siden",
    quality: 82,
    source: "Field App",
    defaultOn: true,
  },
...
export const MOCK_ZONES_GEO = [
  {
    name: "Zone A — Vandløb",
    path: "M60,60 L260,70 L240,200 L80,210 Z",
    area: "1,4 ha",
    habitat: "Vandløb",
    quality: 94,
    lastObs: "2 min",
  ...
  },
  {
    ...
    path: "M260,70 L520,80 L500,210 L240,200 Z",
    area: "3,2 ha",
    habitat: "Eng og vådområde",
    quality: 89,
    lastObs: "5 min",
    sources: 8,
    risk: "Lav" as const,
  },
  {
    ...
    path: "M80,210 L300,205 L280,340 L100,335 Z",
    area: "1,9 ha",
    habitat: "Skovkant",
    quality: 71,
    lastObs: "2 d",
  ...
  },
  {
    ...
    path: "M300,205 L500,210 L520,300 L290,330 Z",
    area: "0,8 ha",
    habitat: "Buffer",
    quality: 76,
    lastObs: "45 min",
...
export const UPLOAD_TYPES = [
  {
    name: "Dronebilleder",
    desc: "Enkeltbilleder fra drone overflyvning",
    onMap: true,
    geo: true,
    use: "Visuel dokumentation",
  },
  {
    name: "Drone orthomosaic",
    desc: "Sammensat dronekort i høj opløsning",
    onMap: true,
    geo: true,
    use: "Coverage og analyse",
  },
  {
    name: "GeoTIFF",
    desc: "Georefereret raster (NDVI, højde, m.m.)",
    onMap: true,
    geo: true,
    use: "Satellit/drone lag",
  },
  {
    name: "GeoJSON",
    desc: "Vektor polygoner og punkter",
    onMap: true,
    geo: true,
    use: "Zoner og grænser",
  },
  { name: "KML/KMZ", desc: "Google Earth lag", onMap: true, geo: true, use: "Eksterne lag" },
  {
    name: "Shapefile ZIP",
    desc: "ESRI shapefile pakket i ZIP",
    onMap: true,
    geo: true,
    use: "GIS import",
  },
  {
    name: "CSV",
    desc: "Tabeldata med koordinatkolonner",
    onMap: true,
    geo: true,
    use: "Punktobservationer",
  },
  { name: "GPX", desc: "GPS-tracks fra felten", onMap: true, geo: true, use: "Field walks" },
  {
    name: "PDF",
    desc: "Metoder, tilladelser, rapporter",
    onMap: false,
    geo: false,
    use: "Dokumentation",
  },
  ...
  {
    name: "Feltdata",
    desc: "Strukturerede feltobservationer",
    onMap: true,
    geo: true,
    use: "Biodiversitet",
  },
  {
    name: "Vandprøver",
    desc: "Lab- eller sensorprøver",
    onMap: true,
    geo: true,
    use: "Vandkvalitet",
  },
  {
    name: "Metodedokumenter",
    desc: "Beskrivelse af målemetode",
    onMap: false,
    geo: false,
    use: "Verifikation",
  },
...
export const UPLOAD_QUEUE = [
  {
    id: "u1",
    name: "Skallebaek_orthomosaic_May2026.tif",
    type: "Drone orthomosaic",
    size: "284 MB",
    project: "Skallebæk Biodiversity Pilot",
    zone: "Hele projektet",
    status: "Klar" as UploadStatus,
    geo: true,
    metaOk: true,
    validationNote: "Coverage 92% af projektarealet",
  },
  {
    id: "u2",
    name: "ZoneC_field_observations.csv",
    type: "CSV",
    size: "84 KB",
    project: "Skallebæk Biodiversity Pilot",
    zone: "Zone C — Skovkant",
    status: "Validering" as UploadStatus,
    geo: true,
    metaOk: false,
    validationNote: "Mangler metodebeskrivelse",
  },
  {
    id: "u3",
    name: "DroneCoverage_NorthEast.geojson",
    type: "GeoJSON",
    size: "12 KB",
    project: "Skallebæk Biodiversity Pilot",
    zone: "Zone B — Eng og vådområde",
    ...
    geo: true,
    metaOk: true,
    validationNote: "Polygon valid",
  },
  {
    id: "u4",
    name: "WaterSamples_Q2_2026.csv",
    type: "CSV",
    size: "38 KB",
    ...
    geo: true,
    metaOk: true,
    validationNote: "Koordinater fundet",
  },
  {
    id: "u5",
    name: "Habitat_Methodology.pdf",
    type: "PDF",
    size: "1,2 MB",
    project: "Skallebæk Biodiversity Pilot",
    zone: "—",
    ...
    geo: false,
    metaOk: true,
    validationNote: "Bilag",
  },
  {
    id: "u6",
    name: "NDVI_layer_June2026.tif",
    type: "GeoTIFF",
    size: "164 MB",
    project: "Urban Biodiversity Corridor Copenhagen",
    zone: "Hele projektet",
    status: "Fejl" as UploadStatus,
    geo: true,
    metaOk: false,
    validationNote: "Projektion (EPSG) ikke genkendt",
  },
  {
    id: "u7",
    name: "Drone_Q2_RAW_pack.zip",
    type: "Dronebilleder",
    size: "1,8 GB",
    project: "Danish Wetland Restoration",
    zone: "Hele projektet",
    status: "Validering" as UploadStatus,
    geo: false,
    metaOk: false,
    validationNote: "EXIF GPS mangler på 12% af billeder",
  },
];
