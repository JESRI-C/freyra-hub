...
export const ACTIVITY_FEED = [
  ...
  {
    module: "DecisionsIQ",
    text: "Ny høj-prioritet anbefaling oprettet — vandkvalitet Zone 3",
    at: "14 min siden",
  ...
  },
  {
    ...
    text: "Skallebæk tilføjet til portefølje",
    at: "3 timer siden",
    tone: "success" as const,
  },
  {
...
export const CRITICAL_ACTIONS = [
  ...
  {
    module: "ESG Ledger",
    title: "4 ESRS-datapunkter mangler dokumentation",
    priority: "Medium",
    owner: "Emma Larsen",
    deadline: "20. jun",
  ...
  {
    module: "Rapporter",
    title: "1 rapport mangler godkendelse",
    priority: "Lav",
    owner: "Jesper Riel",
    deadline: "30. jun",
...
export const NEXT_RECOMMENDED_ACTIONS = [
  ...
  {
    title: "Gennemgå høj-prioritet anbefaling om vandkvalitet",
    module: "DecisionsIQ",
    href: "/app/decisions/recommendations",
  },
  {
    title: "Send Skallebæk dokumentation til ESG Ledger",
    module: "Impact Exchange",
    href: "/app/ledger",
  },
