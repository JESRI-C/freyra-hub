...
export const ORGANIZATIONS: Organization[] = [
  ...
  },
  {
    ...
    trust: 90,
    description:
      "Kommunal projektejer for Skallebæk Biodiversity Pilot og lokal naturgenopretning.",
  ...
  },
  {
    ...
    contactStatus: "Aktiv",
    trust: 86,
    description: "Driver omlægning af landbrugsarealer i Rift Valley til regenerative praksis.",
...
export const ASSETS: ImpactAsset[] = [
  {
    ...
    verification: "Verificeret",
    pricePerUnit: 165,
    ledgerId: "FRY-LDG-1042/A",
  },
  {
    id: "AST-2087-B",
    projectId: "skallebaek",
    type: "Biodiversitetscredit",
    quantity: 85,
    unit: "BU",
    vintage: 2025,
    status: "Reserveret",
    verification: "Under verifikation",
    pricePerUnit: 220,
    ledgerId: "FRY-LDG-2087/B",
  },
  {
    id: "AST-3310-C",
    projectId: "urban-water",
    type: "Vandimpact",
    quantity: 60,
    unit: "WQU",
    vintage: 2025,
    ...
    verification: "Verificeret",
    pricePerUnit: 140,
    ledgerId: "FRY-LDG-3310/C",
  },
  {
    id: "AST-4501-D",
    projectId: "regen-kenya",
    type: "Regenerativ landbrugsimpact",
    quantity: 8800,
    unit: "t CO₂e",
    vintage: 2025,
    status: "Tilgængelig",
  ...
  },
  {
    ...
    verification: "Verificeret",
    pricePerUnit: 110,
    ledgerId: "FRY-LDG-5120/E",
  },
  {
    id: "AST-6088-F",
    projectId: "mangrove-id",
    type: "Naturcredit",
    quantity: 6400,
    unit: "t CO₂e",
    vintage: 2025,
    ...
    verification: "Verificeret",
    pricePerUnit: 130,
    ledgerId: "FRY-LDG-6088/F",
  },
  {
    id: "AST-7042-G",
    projectId: "wind-india",
    type: "CO₂-credit",
    quantity: 19800,
    unit: "t CO₂e",
    vintage: 2025,
    ...
    verification: "Verificeret",
    pricePerUnit: 78,
    ledgerId: "FRY-LDG-7042/G",
  },
  {
    id: "AST-8004-H",
    projectId: "danish-wetland",
    type: "Habitat-enhed",
    quantity: 1400,
    unit: "ha",
    vintage: 2026,
    ...
    verification: "Under verifikation",
    pricePerUnit: 175,
    ledgerId: "FRY-LDG-8004/H",
  },
  {
    id: "AST-9011-I",
    projectId: "baltic-nutrient",
    type: "Vandimpact",
    quantity: 320,
    unit: "WQU",
    vintage: 2026,
    status: "Ikke rapportklar",
    verification: "Planlagt",
    pricePerUnit: 190,
    ledgerId: "FRY-LDG-9011/I",
  },
];
...
export const AUDIT_EVENTS = [
  {
    date: "2026-05-04",
    who: "Bureau Veritas",
    what: "Tredjepartsreview påbegyndt",
    project: "Skallebæk Biodiversity Pilot",
  },
  {
    date: "2026-05-02",
    who: "Sentinel-2 layer",
    what: "Satellitlag opdateret (vegetationsindeks)",
    project: "Amazonas Forest Protection",
  },
  {
    date: "2026-04-28",
    who: "AI risk monitor",
    what: "Risiko-flag gennemgået og lukket",
    project: "Urban Water Quality Program",
  },
  {
    date: "2026-04-22",
    who: "Feltteam DK-3",
    what: "Feltobservation tilføjet (12 arter)",
    project: "Skallebæk Biodiversity Pilot",
  },
  {
    date: "2026-04-18",
    who: "Freyra Reporting",
    what: "ESG-bilag genereret og signeret",
...
export const REPORTS = [
  {
    id: "RPT-001",
    name: "ESG-bilag Q1 2026 — Samlet portefølje",
    type: "ESG-bilag",
    scope: "Portefølje",
    created: "2026-04-12",
    status: "Eksporteret",
  ...
  {
    id: "RPT-002",
    name: "Projektfakta — Skallebæk Biodiversity Pilot",
    type: "Projektfakta",
    scope: "Skallebæk",
    created: "2026-04-08",
    status: "Klar",
  ...
  {
    id: "RPT-003",
    name: "Verifikationsrapport — Nordic Coastal",
    type: "Verifikationsrapport",
    scope: "Nordic Coastal",
    created: "2026-03-30",
    status: "Under review",
    sentToLedger: false,
  },
  {
    id: "RPT-004",
    name: "Ledelsesnotat — Q1 impact-resultater",
    type: "Ledelsesnotat",
    scope: "Portefølje",
    created: "2026-03-20",
    status: "Eksporteret",
