...
export const RECOMMENDATIONS: Recommendation[] = [
  {
    ...
    whyItMatters:
      "Energiforbruget udgør 22% af projektets samlede CO₂e og påvirker ESG-scoren direkte.",
    dataBasis: [
      "IoT energimålere (12 mdr.)",
      "Sammenligningsindeks Norden",
      "Vejrnormaliseret model",
    ],
...
export const KEY_INSIGHTS: Insight[] = [
  ...
  {
    label: "Anbefalet næste handling",
    value: "Re-beregn CO₂e",
    tone: "info",
...
export const TIMELINE_CHANGES = [
  {
    month: "Maj",
    icon: "co2",
    label: "CO₂e faldet 4,2% efter optimering af bygning A",
    tone: "success" as const,
  },
  {
    month: "Maj",
    icon: "bio",
    label: "Biodiversitetsindeks i område A steget til 0,74",
    tone: "success" as const,
  },
  {
    month: "Apr",
    icon: "water",
    label: "Vandkvalitet i zone 3 faldet under tærskel",
    tone: "danger" as const,
  },
  {
    month: "Apr",
    icon: "data",
    label: "Datadækning øget med 8% fra nye sensorer",
    tone: "info" as const,
  },
  {
    month: "Mar",
    icon: "anomaly",
    label: "Anomali registreret i sensor WQ-12",
...
export const RISK_CATEGORIES = [
  ...
  {
    name: "Biodiversitetsrisiko",
    score: 41,
    trend: "−8",
    level: "Lav" as RiskLevel,
  ...
  {
    name: "Datakvalitetsrisiko",
    score: 71,
    trend: "+6",
    level: "Høj" as RiskLevel,
...
export const RISK_MATRIX_POINTS = [
  ...
  {
    name: "Manglende feltverifikation",
    probability: 0.6,
    impact: 0.5,
    level: "Medium" as RiskLevel,
  },
...
export const RISK_TIMELINE = [
  ...
  {
    date: "02. maj",
    event: "Sensor WQ-12 mistede heartbeat i 6 timer",
    level: "Medium" as RiskLevel,
  },
  { date: "27. apr", event: "Habitatdækning faldt 4% i område B", level: "Medium" as RiskLevel },
  {
    date: "19. apr",
    event: "Emissionsfaktor-bibliotek markeret som forældet",
    level: "Høj" as RiskLevel,
  },
...
export const MITIGATIONS = [
  {
    action: "Genkalibrér vandsensorer i zone 3",
    owner: "Emma Larsen",
    deadline: "20. jun",
    status: "Igangsat",
    effect: "−25% risiko",
  ...
  {
    action: "Udrul felt-app til 6 medarbejdere",
    owner: "Mikkel Holm",
    deadline: "15. aug",
    status: "Planlagt",
    effect: "−18% risiko",
  ...
  {
    action: "Opdatér emissionsfaktor-bibliotek",
    owner: "Jesper Riel",
    deadline: "12. jun",
    status: "Åben",
    effect: "−12% risiko",
  ...
  {
    action: "Etabler satellit-monitorering område B",
    owner: "Jesper Riel",
    deadline: "01. jul",
    status: "Åben",
    effect: "−15% risiko",
...
export const SCENARIOS = [
  ...
  {
    id: "bio",
    name: "Biodiversitetsindsats øges",
    tag: "Medium investering",
...
export const DATA_SOURCES = [
  ...
  },
  {
    ...
    verification: "B",
    missing: "12%",
    improvement: "Genaktivér Sentinel-2 pipeline",
  },
  {
    name: "Dronebilleder",
    status: "Aktiv",
    ...
    verification: "A",
    missing: "4%",
    improvement: "Planlæg næste flyvning",
  },
  {
    name: "Manuelle feltdata",
    status: "Mangelfuld",
    lastSync: "9 dage",
    quality: 62,
    verification: "B",
    missing: "32%",
    improvement: "Udrul felt-app + træning",
  },
  {
    name: "Tredjepartsdata",
    status: "Aktiv",
    lastSync: "1 dag",
    quality: 90,
    verification: "A",
    missing: "2%",
    improvement: "Tilføj ekstra leverandør",
  },
  {
    name: "ESG-systemer",
    status: "Aktiv",
    ...
    verification: "A",
    missing: "3%",
    improvement: "Validér emissionsfaktorer",
  },
  {
    name: "CSV uploads",
    status: "Inaktiv",
    ...
    verification: "C",
    missing: "—",
    improvement: "Migrer til API-integration",
  },
];
...
export const SAVED_NOTES = [
  {
    id: "n-1",
    title: "Q2 statusnotat — Limfjorden",
  ...
  {
    id: "n-2",
    title: "Risikoopdatering — vandkvalitet",
  ...
  {
    id: "n-3",
    title: "Biodiversitetsfremgang Q2",
    project: "Skallebæk Biodiversity Pilot",
    audience: "Intern ledelse",
    date: "28. apr 2026",
    status: "Udkast",
  },
  {
    id: "n-4",
    title: "ESG-status til bestyrelse",
    project: "Nordic Coastal Restoration",
    audience: "Intern ledelse",
    date: "14. apr 2026",
    status: "Eksporteret",
...
export const SAMPLE_ASSISTANT_REPLIES: Record<
  string,
  {
    short: string;
    basis: string[];
...
> = {
  default: {
    short:
      "Projektet er overordnet på rette kurs, men datakvalitet og vandkvalitet i zone 3 kræver opmærksomhed.",
    basis: [
      "Sensor- og satellitdata sidste 30 dage",
      "Felt-observationer Q2",
      "ESG-indikatorer fra ledger",
    ],
    recommendation:
      "Prioritér genkalibrering af WQ-12 og opdatering af emissionsfaktorer før Q2-rapport.",
  ...
  risici: {
    short:
      "Tre risici stikker ud: vandkvalitet zone 3 (Kritisk), datakvalitet (Høj) og forældede emissionsfaktorer (Høj).",
  ...
  co2: {
    ...
    recommendation:
      "Gennemfør anbefaling 'Reducer energiforbruget i bygning A' og opdatér transportfaktorer.",
