...
export function Toggle({
  ...
  return (
    ...
    >
      <span
        className={`relative inline-block h-5 w-9 rounded-full transition ${checked ? "bg-primary" : "bg-muted"}`}
      >
        <span
...
export function PermissionCell({ level }: { level: "full" | "limited" | "none" }) {
  if (level === "full")
    return (
      <span
        className="inline-flex items-center justify-center h-6 w-6 rounded-md bg-success/15 text-success"
        title="Fuld adgang"
      >
  ...
  if (level === "limited")
    return (
      <span
        className="inline-flex items-center justify-center h-6 w-6 rounded-md bg-warning/20 text-warning-foreground"
        title="Begrænset"
      >
  ...
  return (
    <span
      className="inline-flex items-center justify-center h-6 w-6 rounded-md bg-muted text-muted-foreground"
      title="Ingen adgang"
    >
