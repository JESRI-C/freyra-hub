-- COALESCE is PostgreSQL syntax, not a schema-qualified pg_catalog function.
-- Recreate the finalizer so already-migrated environments can move uploaded
-- objects into the backend-validation queue.
