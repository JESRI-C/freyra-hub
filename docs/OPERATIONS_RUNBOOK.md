...
- Den isolerede staging `xdvqdzdpyceojbdknofi` er `ACTIVE_HEALTHY`. Den registrerede livehistorik indeholder `20260831172610`, `20260831172839`, `20260901163924`, `20260902153933`, `20260912110614` og `20260912132006`. Sidste version retter finalizerens ugyldige `pg_catalog.coalesce(...)` til PostgreSQL-syntaksen `coalesce(...)` uden at lempe adgangskontroller eller grants. Den samlede kildemigration `20260912112500` er fortsat ikke anvendt. Det samlede schema er ikke produktionsklart: frisk lokal replay, pgTAP `plan(107)`, DB-lint, hele rolle-/Storage-matricen og review af produktionsdata mangler fortsat.
