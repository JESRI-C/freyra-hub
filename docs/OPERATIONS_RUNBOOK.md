...
Kør desuden målrettede tests før hele suiten. Verificeret worktree 2026-09-13, cyklus 024: typecheck PASS; målrettet monitoring-download/navigation 2 filer/43 tests PASS; målrettet ESLint på fire filer 0 fund; fuld serial Vitest 58 filer/498 tests PASS; normalt produktionsbuild og `git diff --check` PASS. Staging-build/dry-run og hosted app er fortsat cyklus 019: appcommit `d66e2d7` som Worker-version `94063d2d-a77d-4b5d-bfb8-9a32dbe94319`. Migrationskilden har pgTAP `plan(113)`, men de 113 cases er ikke runtime-kørt; lokal replay/pgTAP/DB-lint forbliver blokeret uden lokal Postgres på `127.0.0.1:54322`. Seneste globale lint er fortsat rød med 5.188 errors/23 warnings og skal ned på 0 før P0-release.
