...
Kør desuden målrettede tests før hele suiten. Verificeret worktree 2026-09-13, cyklus 025: typecheck PASS; målrettet atomisk observations-/auth-/migrationkæde 4 filer/62 tests PASS; målrettet ESLint på fem authored TypeScript-filer 0 fund; fuld serial Vitest 59 filer/511 tests PASS; normalt produktionsbuild og `git diff --check` PASS. Ved den brugerautoriserede stagingudgivelse bestod typecheck, de samme 4 filer/62 tests, `build:staging`, bundle/ref-secretkontrol og Wrangler `--strict --dry-run`; appcommit `f337920` er aktiv 100 % som Worker-version `75f856e9-5915-44ad-9923-e2dd41f3d573`. Migrationskilden har pgTAP `plan(128)`, men hele suiten er ikke runtime-kørt; cyklus 025's lokale pgTAP-/DB-lintforsøg stoppede begge på `ECONNREFUSED 127.0.0.1:54322`. Seneste globale lint er fortsat rød med 5.188 errors/23 warnings og skal ned på 0 før P0-release.
